...
export default function Home() {
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="container relative z-10 text-center text-white">
          <h1 className="font-serif text-4xl md:text-6xl font-bold mb-4">
            ...
            <span className="block mt-2">The Hidden Pearl of Haqiqat.</span>
          </h1>
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
            Dr. Ghulam Mohammad Kumar – A Saint Beyond Time, A Healer Beyond Form.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Button size="lg" className="bg-[#E6C67C] hover:bg-[#D4B46A] text-black" asChild>
              <Link href="/his-life">
      ...
      <section id="life" className="py-20 bg-white dark:bg-gray-950">
      ...
      {/* Sainthood - Fana & Baqa */}
      <section id="teachings" className="py-20 bg-gray-50 dark:bg-gray-900">
        <div className="container">
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-center mb-6">Sainthood – Fana & Baqa</h2>
          ...
          <div className="text-center max-w-2xl mx-auto p-8 border border-[#E6C67C]/30 rounded-lg bg-white/50 dark:bg-gray-800/50 shadow-sm">
      ...
      <section id="domains" className="py-20 bg-white dark:bg-gray-950">
        <div className="container">
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-center mb-12">Divine Domains of Dr. Kumar</h2>
      ...
      <section id="legacy" className="py-20 bg-gray-50 dark:bg-gray-900">
        <div className="container">
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-center mb-12">Dr. Kumar's Global Legacy</h2>
          ...
          <div>
            <h3 className="font-serif text-2xl font-bold text-center mb-6">Foundation Projects</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <Link href="/projects/healing-programs" className="block">
                <Card className="h-full transition-all hover:shadow-md">
                  <CardContent className="p-4 text-center">
                    <h4 className="font-medium mb-2">Healing Programs</h4>
              ...
              <Link href="/projects/water-protection" className="block">
                <Card className="h-full transition-all hover:shadow-md">
                  <CardContent className="p-4 text-center">
                    <h4 className="font-medium mb-2">Water Protection</h4>
                    <p className="text-sm text-muted-foreground">Preserving the sacred waters of Kashmir and beyond</p>
                  </CardContent>
                </Card>
              </Link>
              <Link href="/projects/youth-rehabilitation" className="block">
                <Card className="h-full transition-all hover:shadow-md">
                  <CardContent className="p-4 text-center">
                    <h4 className="font-medium mb-2">Youth Rehabilitation</h4>
                    <p className="text-sm text-muted-foreground">Guiding troubled youth through spiritual practices</p>
                  </CardContent>
                </Card>
              </Link>
              <Link href="/projects/craft-revival" className="block">
                <Card className="h-full transition-all hover:shadow-md">
                  <CardContent className="p-4 text-center">
                    <h4 className="font-medium mb-2">Craft Revival</h4>
                    <p className="text-sm text-muted-foreground">Preserving traditional Kashmiri arts and crafts</p>
                  </CardContent>
                </Card>
              </Link>
            </div>
      ...
      {/* Multimedia Library */}
      <section id="media" className="py-20 bg-white dark:bg-gray-950">
        <div className="container">
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-center mb-6">SufiPulse Media</h2>
          <p className="text-center text-lg mb-12 max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            ...
            <Link href="/media-library?category=performance">
              <Button variant="outline">Performances</Button>
            </Link>
            ...
            <Link href="/media-library?category=chants">
              <Button variant="outline">Chants</Button>
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="group relative overflow-hidden rounded-lg">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end">
                  <div className="p-4 text-white">
                    <h3 className="font-medium">Divine Resonance Live</h3>
                    <p className="text-sm opacity-80">Performance | 70 min</p>
                  </div>
                </div>
              </div>
            </Link>
            ...
            <Link href="/media-library/echoes-of-silence" className="block">
              <div className="group relative overflow-hidden rounded-lg">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end">
                  <div className="p-4 text-white">
                    <h3 className="font-medium">Echoes of Silence</h3>
                    <p className="text-sm opacity-80">Music Album | 53 min</p>
                  </div>
                </div>
              </div>
            </Link>
            ...
            <Link href="/media-library/healing-chants-kashmir" className="block">
              <div className="group relative overflow-hidden rounded-lg">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end">
                  <div className="p-4 text-white">
                    <h3 className="font-medium">Healing Chants of Kashmir</h3>
                    <p className="text-sm opacity-80">Chants | 40 min</p>
                  </div>
                </div>
              </div>
            </Link>
            ...
            <Link href="/media-library/rhythm-of-presence" className="block">
              <div className="group relative overflow-hidden rounded-lg">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end">
                  <div className="p-4 text-white">
                    <h3 className="font-medium">Rhythm of Presence</h3>
                    <p className="text-sm opacity-80">Music | Meditation</p>
                  </div>
                </div>
              </div>
            </Link>
            ...
            <Link href="/media-library/interview-sufipulse-artist" className="block">
              <div className="group relative overflow-hidden rounded-lg">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end">
                  <div className="p-4 text-white">
                    <h3 className="font-medium">Interview with a SufiPulse Artist</h3>
                    <p className="text-sm opacity-80">Interview | 25 min</p>
                  </div>
                </div>
              </div>
            </Link>
            ...
            <Link href="/media-library/sufipulse-documentary" className="block">
              <div className="group relative overflow-hidden rounded-lg">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end">
                  <div className="p-4 text-white">
                    <h3 className="font-medium">The Heartbeat of SufiPulse</h3>
                    <p className="text-sm opacity-80">Documentary | 30 min</p>
                  </div>
                </div>
              </div>
            </Link>
      ...
      {/* Support the Mission */}
      <section id="involved" className="py-20 bg-gray-50 dark:bg-gray-900">
        <div className="container">
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-center mb-6">Support the Mission</h2>
          <p className="text-center text-lg mb-12 max-w-3xl mx-auto font-serif italic">
      ...
      {/* Visitor Counter */}
      <div className="py-8 bg-gray-50 dark:bg-gray-900 text-center">
        <p className="text-muted-foreground">You are the 14,000th heart to walk this path. Every seeker matters.</p>
      </div>
    </div>
  )
}
